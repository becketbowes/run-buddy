(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[63],{"2z/i":function(e,o,c){"use strict"
var t=c("HGxv")
var l=c("8WeW")
...
return a()?{isCyoeAble:e&&o,isTrigger:e&&o&&i(e),isReleased:d(e),releasedLabel:u(e)}:{}}}},G4i8:function(e,o,c){var t={"./__tests__/lti.resourceImported.test.js":["LFe7",4142],"./__tests__/lti.screenReaderAlert.test.js":["0Guc",4143],"./__tests__/requestFullWindowLaunch.test.js":["o6ta",4144],"./lti.enableScrollEvents.js":["HVU3",4202],"./lti.fetchWindowSize.js":["OANa",4203],"./lti.frameResize.js":["bSyB",4133],"./lti.removeUnloadMessage.js":["tjuu",4145],"./lti.resourceImported.js":["FC2N",4204],"./lti.screenReaderAlert.js":["YYEg",4205],"./lti.scrollToTop.js":["W/R1",4206],"./lti.setUnloadMessage.js":["6fDN",4146],"./lti.showModuleNavigation.js":["NSTA",4207],"./requestFullWindowLaunch.js":["8IHO",4208],"./toggleCourseNavigationMenu.js":["ECMy",3641,4209]}
...
const _="bad_request"
const s=({targetWindow:e,origin:o,subject:c,message_id:t})=>{const s=(r={})=>{const n={subject:c+".response"}
t&&(n.message_id=t)
...
const k=()=>{d(a)}
const b=()=>{d(n)}
return{sendResponse:s,sendSuccess:i,sendError:d,sendGenericError:u,sendBadRequestError:p,sendWrongOriginError:k,sendUnsupportedSubjectError:b}}
var i=s
const d={}
...
async function k(e,o=false){if(e.data.source&&e.data.source.includes("react-devtools"))return false
let t
try{t="string"===typeof e.data?JSON.parse(e.data):e.data}catch(e){return false}const l=t.subject||t.messageType
const r=i({targetWindow:e.source,origin:e.origin,subject:l,message_id:t.message_id})
if(p.includes(l))return false
if(!u.includes(l)){o&&r.sendUnsupportedSubjectError()
return false}try{const n=await c("G4i8")(`./${l}.js`)
...
return false}}function b(){var e,o
const c=null===(e=ENV)||void 0===e||null===(o=e.FEATURES)||void 0===o?void 0:o.lti_platform_storage
window.addEventListener("message",e=>{""!==e.data&&k(e,c)})}}}])

//# sourceMappingURL=63-c-e8c8047119.js.map