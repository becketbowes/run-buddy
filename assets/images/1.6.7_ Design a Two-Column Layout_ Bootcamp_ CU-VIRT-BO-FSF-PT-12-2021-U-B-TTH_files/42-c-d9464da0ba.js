(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[42,3642],{"897F":function(e,t,a){"use strict"
var n=a("ouhR")
var r=a.n(n)
var i=a("Y/W1")
var s=a.n(i)
...
return{name:e,value:t}}function g(){const e=r()(this)
...
return r.a.isArray(t)?t.map(e=>d(this.name,e)):d(this.name,t)}r.a.fn.serializeForm=function(){return this.map(u).filter(c).map(g).get()}},br6r:function(e,t,a){"use strict"
var n=a("mX+G")
var r=a.n(n)
var i=a("RoCN")
var s=a("ouhR")
...
t.prototype.submit=function(e,t){var a,n,r,i,s,l,c,d,g
null==t&&(t=h["d"])
...
this.trigger("submit")
return g}r=u.a.map(o()("[data-error-type]"),(function(e){return o()(e).attr("data-error-type")}))
...
return e.forEach((function(e){return Object(h["d"])(o()(e),"RCEClosed")}))}
...
return{}}}
t.prototype.translations=Object(p["b"])({},{required:function(){return g.t("required","Required")},blank:function(){return g.t("blank","Required")},unsaved:function(){return g.t("unsaved_changes","You have unsaved changes.")}})
...
h[p]=g((function(e,t,a,n,r){this.compilerInfo=[4,">= 1.0.0"]
...
//# sourceMappingURL=42-c-d9464da0ba.js.map