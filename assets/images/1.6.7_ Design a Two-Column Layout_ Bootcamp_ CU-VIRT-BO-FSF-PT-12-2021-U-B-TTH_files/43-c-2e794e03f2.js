(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[43],{"65NJ":function(e,i,t){"use strict"
var l=t("ouhR")
var n=t.n(l)
t("w2hD")
...
let l=t.offset(),u=t.outerWidth(),s=t.outerHeight(),c=l.top,o=c+s,a=l.left,b=a+u,r="html,body"==this.selector?n.a.windowScrollTop():this.scrollTop(),p=this.scrollLeft(),h=this.outerHeight(),_=this.outerWidth()
...
a-=p
o-=r
b-=p}c<0||h<s&&o>h?i.scrollTop=c+r:o>h&&(i.scrollTop=o+r-h+20)
...
i.length||(i=c()('<span class="screenreader-only accessible_label"></span>').appendTo(this.$el))
i.text(e)
...
i.disable()
i.render()
return i.setFocusToElement()})).fail(function(e){return function(i){403===i.status&&c.a.flashError(e.model.disabledMessage())
e.disable()
e.renderPublished()
...
t("65NJ")
t("w2hD")
c.a.fn.setOptions=function(e,i){let t=e?"<option value=''>"+Object(o["a"])(e)+"</option>":""
null==i&&(i=[])
i.forEach(e=>{const i=Object(o["a"])(e)
t+='<option value="'+i+'">'+i+"</option>"})
return this.html(c.a.raw(t))}
c.a.fn.ifExists=function(e){this.length&&e.call(this,this)
return this}
c.a.fn.scrollbarWidth=function(){const e=c()('<div style="width:50px;height:50px;overflow:hidden;position:absolute;top:-200px;left:-200px;"><div style="height:100px;"></div>').appendTo(this),i=e.find("div")
...
const n=function(){if(!l){e.cancelled&&c.a.isFunction(e.cancelled)&&e.cancelled.call(i)
...
c.a.ajaxJSON(e.url,"DELETE",l,t=>{e.success.call(i,t)},(t,l,n,u)=>{e.error&&c.a.isFunction(e.error)?e.error.call(i,t,l,n,u):c.a.ajaxJSON.unhandledXHRs.push(l)})}else{e.success||(e.success=function(){i.fadeOut("slow",()=>{i.remove()})})
e.success.call(i)}}
if(e.message&&!e.noMessage&&!c.a.skipConfirmations){if(e.dialog){l=false
const i="object"===typeof e.dialog?e.dialog:{}
const s=e.url.includes("assignments")?"btn-danger":"btn-primary"
t=c()(e.message).dialog(c.a.extend({},{modal:true,close:n,buttons:[{text:u.t("#buttons.cancel","Cancel"),click(){c()(this).dialog("close")}},{text:u.t("#buttons.delete","Delete"),class:s,click(){l=true
c()(this).dialog("close")}}]},i))
return}l=confirm(e.message)}n()}
c.a.fn.confirmDelete.defaults={get message(){return u.t("confirms.default_delete_thing","Are you sure you want to delete this?")}}
c.a.fn.fragmentChange=function(e){if(e&&true!==e){const t=(window.location.search||"").replace(/^\?/,"").split("&")
let l=null
for(var i=0;i<t.length;i++){const e=t[i]
e&&0===e.indexOf("hash=")&&(l="#"+e.substring(5))}this.bind("document_fragment_change",e)
const n=this
let u=false
for(i=0;i<c.a._checkFragments.fragmentList.length;i++){const e=c.a._checkFragments.fragmentList[i]
e.doc[0]==n[0]&&(u=true)}u||c.a._checkFragments.fragmentList.push({doc:n,fragment:""})
...
c.a._checkFragments.fragmentList[i]=t}}}
c.a._checkFragments.fragmentList=[]
c.a.fn.clickLink=function(){const e=this.eq(0)
e.hasClass("disabled_link")||e.click()}
c.a.fn.showIf=function(e){if(c.a.isFunction(e))return this.each((function(i){c()(this).showIf(e.call(this))}))
...
i.mouseover((function(){c()(this).stop().fadeOut("fast",(function(){c()(this).remove()}))}))
this.data("indicator")&&this.indicate("remove")
this.data("indicator",i)
c()("body").append(i)
e&&e.singleFlash?i.hide().fadeIn().animate({opacity:.8},500).fadeOut("slow",(function(){c()(this).remove()})):i.hide().fadeIn().animate({opacity:.8},500).fadeOut("slow").fadeIn("slow").animate({opacity:.8},2500).fadeOut("slow",(function(){c()(this).remove()}))
e&&e.scroll&&c()("html,body").scrollToVisible(i)}
...
return this}
c.a.fn.fillWindowWithMe=function(e){const i=c.a.extend({minHeight:400},e),t=c()(this),l=c()("#wrapper"),n=c()("#main"),u=c()("#not_right_side"),s=c()(window),o=c()(this).add(i.alsoResize)
function a(){o.height(0)
const e=s.height()-(l.offset().top+l.outerHeight())+(n.height()-u.height()),a=Math.max(400,e)
o.height(a)
c.a.isFunction(i.onResize)&&i.onResize.call(t,a)}a()
...
this.filter("input:text").each((function(){let i=e.minWidth||c()(this).width(),t="",l=c()(this),n=c()("<tester/>").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:l.css("fontSize"),fontFamily:l.css("fontFamily"),fontWeight:l.css("fontWeight"),letterSpacing:l.css("letterSpacing"),whiteSpace:"nowrap"}),u=function(){setTimeout(()=>{if(t===(t=l.val()))return
n.text(t)
const u=n.width(),s=u+e.comfortZone>=i?u+e.comfortZone:i,c=l.width(),o=s<c&&s>=i||s>i&&s<e.maxWidth
o&&l.width(s)})}
n.insertAfter(l)
c()(this).bind("keyup keydown blur update change",u)}))
return this}
c.a}}])

//# sourceMappingURL=43-c-2e794e03f2.js.map