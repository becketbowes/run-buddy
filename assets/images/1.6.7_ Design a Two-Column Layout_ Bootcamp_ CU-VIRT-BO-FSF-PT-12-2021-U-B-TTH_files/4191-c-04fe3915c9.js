...
var m=a("gI0r")
function c(e){e.data("handled",true)
const t=e.data("url")||e.attr("href")
const a=e.data("method")
const i=e.attr("target")
const d=n()(`<form method="post" action="${Object(m["a"])(t)}"></form>`)
const r=`\n    <input name="_method" value="${Object(m["a"])(a)}" type="hidden" />\n    <input name="authenticity_token" type="hidden" />\n  `
i&&d.attr("target",i)
...
return false}if(t.data("method")){c(t)
return false}}))
...
t.data("orig-width",a)
t.css("width",K+"px")}
n()(document).on("click","a.instructure_inline_media_comment",Object(d["a"])((function(){if(!INST.kalturaSettings){alert(z.t("alerts.kaltura_disabled","Kaltura has been disabled for this Canvas site"))
...
y.collapseComment(i)}))
Object(w["a"])("show_embedded_content","show_media")
i.find(".innerholder").css("outline","none")
i.find(".innerholder").on("focus",C)})))
function O(e,t){return"undefined"!==typeof e&&null!==e?t(e):void 0}if(ENV.ping_url){const e=setInterval(()=>{document.hidden||n.a.post(ENV.ping_url).fail(t=>{401===t.status&&clearInterval(e)})},18e4)}Object(v["a"])(JSON.parse('{"ar":{"locked_image_24f37a16":"صورة مؤمّنة"},"ca":{"locked_image_24f37a16":"Imatge bloquejada"},"cy":{"locked_image_24f37a16":"Delwedd wedi’i chloi"},"da":{"locked_image_24f37a16":"Låst billede"},"da-x-k12":{"locked_image_24f37a16":"Låst billede"},"de":{"locked_image_24f37a16":"Gesperrtes Bild"},"en-AU":{"locked_image_24f37a16":"Locked image"},"en-AU-x-unimelb":{"locked_image_24f37a16":"Locked image"},"en-CA":{"locked_image_24f37a16":"Locked image"},"en-GB":{"locked_image_24f37a16":"Locked image"},"en-GB-x-lbs":{"locked_image_24f37a16":"Locked image"},"en-GB-x-ukhe":{"locked_image_24f37a16":"Locked image"},"es":{"locked_image_24f37a16":"Imagen bloqueada"},"es-ES":{"locked_image_24f37a16":"Imagen bloqueada"},"fa":{"locked_image_24f37a16":"تصویر قفل شده"},"fi":{"locked_image_24f37a16":"Lukittu kuva"},"fr":{"locked_image_24f37a16":"Image verrouillée"},"fr-CA":{"locked_image_24f37a16":"Image verrouillée"},"ht":{"locked_image_24f37a16":"Imaj Bloke"},"is":{"locked_image_24f37a16":"Læst mynd"},"it":{"locked_image_24f37a16":"Immagine bloccata"},"ja":{"locked_image_24f37a16":"ロックされた画像"},"mi":{"locked_image_24f37a16":"Āhua kua rakaina"},"nb":{"locked_image_24f37a16":"Låst bilde"},"nb-x-k12":{"locked_image_24f37a16":"Låst bilde"},"nl":{"locked_image_24f37a16":"Vergrendelde afbeelding"},"nn":{"locked_image_24f37a16":"Låst bilde"},"pl":{"locked_image_24f37a16":"Zablokowany obraz"},"pt":{"locked_image_24f37a16":"Imagem bloqueada"},"pt-BR":{"locked_image_24f37a16":"Imagem bloqueada"},"ru":{"locked_image_24f37a16":"Заблокированное изображение"},"sl":{"locked_image_24f37a16":"Zaklenjena slika"},"sv":{"locked_image_24f37a16":"Låst bild"},"sv-x-k12":{"locked_image_24f37a16":"Låst bild"},"th":{"locked_image_24f37a16":"ภาพที่ล็อคไว้"},"zh-Hans":{"locked_image_24f37a16":"锁定图片"},"zh-Hant":{"locked_image_24f37a16":"鎖定圖像"}}'))
...
t.width=100
t.height=100}else a()},a):a()})}function A(){Array.from(document.querySelectorAll('img:not([src=""])')).forEach(B)}S()(A)
...
//# sourceMappingURL=4191-c-04fe3915c9.js.map